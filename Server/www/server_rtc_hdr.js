...
app.use(serveIndex('./rtc_hdr'));
app.use(express.static('./rtc_hdr'));
...
app.get("/rtc_hdr",function (req,res,next) {
    res.sendFile(__dirname+"/rtc_hdr/rtc_hdr.html");
});
 
server.listen(8087);//express 监听 8080 端口，因为本机80端口已被暂用
