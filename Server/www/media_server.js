...
app.use(serveIndex('./media_rtc'));
app.use(express.static('./media_rtc'));
...
app.get("/media_rtc",function (req,res,next) {
    res.sendFile(__dirname+"/media_rtc/publisher.html");
});
 
server.listen(9603);//express 监听 8080 端口，因为本机80端口已被暂用
