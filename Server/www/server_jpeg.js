...
app.use(serveIndex('./jpeg'));
app.use(express.static('./jpeg'));
...
app.get("/jpeg",function (req,res,next) {
    res.sendFile(__dirname+"/jpeg/publisher.html");
});
 
server.listen(8089);//express 监听 8080 端口，因为本机80端口已被暂用
