...
namespace RTC
{
	...
	RtpProbationGenerator::RtpProbationGenerator()
	{
		...
		this->probationPacket->SetSequenceNumber( static_cast<uint16_t>(s_crypto_random.GetRandomUInt(0, 65535)));
		this->probationPacket->SetTimestamp(s_crypto_random.GetRandomUInt(0, 4294967295));
