...
namespace RTC
{
	...
	private:
		struct SrtpCryptoSuiteMapEntry
		{
			...
			chen::ECRYPTO_SUITE cryptoSuite;;
			const char* name;
		};
		...
		public:
			...
			virtual void OnDtlsTransportConnected(
			  const RTC::DtlsTransport* dtlsTransport,
				chen::ECRYPTO_SUITE srtpCryptoSuite,
	...
	private:
		...
		void ExtractSrtpKeys(chen::ECRYPTO_SUITE srtpCryptoSuite);
		chen::ECRYPTO_SUITE GetNegotiatedSrtpCryptoSuite();
