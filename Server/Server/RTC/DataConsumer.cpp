...
namespace RTC
{
	...
	DataConsumer::DataConsumer(
	  ...
	  json& data,
	  size_t maxMessageSize, const std::string & displayName)
	  : id(id), dataProducerId(dataProducerId), listener(listener), maxMessageSize(maxMessageSize), displayName(displayName)
	{
		MS_TRACE();
